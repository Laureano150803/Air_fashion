...
const Sidebar = () => {
  ...
  return (
    <>
      <div className='flex '>
        <div className={`${open ? "w-72" : "w-20"} duration-300 p-5 pt-8 h-screen bg-slate-100 relative`}>
          ...
          <div className="flex flex-col gap-6 ">
            ...
            <div className="flex flex-col gap-2">
              ...
              <Link to={'/ListHairdresser'} className="flex gap-x-4 items-center  hover:text-violet-600 h-14 rounded-2xl hover:bg-slate-200 ">
                ...
                <a className={`${!open && 'scale-0'} origin-left texbp text-lg duration-300 font-bold `}>Team</a>
              ...
              <Link to={'/CrudService'} className="flex gap-x-4 items-center  hover:text-violet-600 h-14 rounded-2xl hover:bg-slate-200 ">
                ...
                <a className={`${!open && 'scale-0'} origin-left texbp text-lg duration-300 font-bold `}>services</a>
              ...
              <Link to={'/'} className="flex gap-x-4 items-center  hover:text-violet-600 h-14 rounded-2xl hover:bg-slate-200 ">
                ...
                <a className={`${!open && 'scale-0'} origin-left texbp text-lg duration-300 font-bold `}>calendar</a>
