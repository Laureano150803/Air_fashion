    ...
    return (
        <>
            ...
            <div className=" flex flex-col justify-evenly">
                ...
                <div className=" flex w-[100%] justify-around mt-10">
                    <div className="w-[30%] flex flex-col">
                        <h1 className=' aboutUs mb-3 text-3xl'>Get in Touch with Us</h1>
                        <p className='aboutUs text-lg'>For us it is important to have excellent customer service and give the greatest importance to all your needs and we understand our clients so much that we decided to set up this hair salon in the center of the city. Being located in the city center, Hair fashion will be more accessible to a wide range of customers. People who live, work or visit the area will have easy access to its services.</p>
                        <div className="aboutUs ">
                            <h1 className='text-2xl mt-5 mb-5' >Contact Information</h1>
