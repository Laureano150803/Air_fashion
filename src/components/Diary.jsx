            ...
            <div className="min-h-screen ">
                <div className=" flex items-center justify-evenly">
                    <div className="p-7  w-[65rem]  rounded-xl ">
                        <div className="flex flex-col shadow-md rounded-lg overflow-y-scroll h-[50rem] ">
                            <div className="bg-gradient-to-r from-sky-400 to-cyan-300 rounded-xl p-7 sticky top-0 z-10">
