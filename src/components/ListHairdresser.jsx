                ...
                <div className="flex justify-evenly items-center min-h-screen">
                    ...
                    <div className="relative overflow-x-auto shadow-md sm:rounded-lg w-[55%]">
                        <div className="flex items-center justify-around py-4 bg-gradient-to-r from-cyan-500 to-blue-500  ">
                            ...
                            <button  className="flex justify-center  items-center gap-x-2 bg-white w-60 p-2 rounded-lg ">
                        ...
                        <table className="w-full text-sm text-left dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                {peluqueros.map((peluquero) => (
                                    <tr className="bg-white border-t  dark:border-blue-200 hover:text-white dark:hover:bg-gradient-to-r from-cyan-500 to-blue-500 ">
                                        ...
                                        <td className="px-6 py-4">
                                            <div className="flex gap-x-4 items-center ">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-purple-600 ">
                    ...
                    <div className="w-[35%] mt-5">
                        ...
                        <form onSubmit={asignaremail}>
                            ...
                            <div className="relative z-0 w-full mb-6 group">
                                <input ref={foto} type="text" name="floating_company" id="floating_company" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
